  ...
  return (
    <footer className="w-full bg-white/90 border-t border-gray-100 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <span className="text-lg font-bold text-primary">Ario Finance</span>
        <span className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} ArionexTech. All rights reserved.</span>
